      ...
      async ({ coords }) => {
        try {
          ...
          if (data?.features?.length) {
            ...
            const addr = [p.name, p.street, p.city, p.state, p.country]
              .filter(Boolean)
              .join(", ");
            setPickup(addr);
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-6 px-1">
          <motion.button
            whileTap={{ scale: 0.88 }}
            onClick={() => router.back()}
            className="w-11 h-11 rounded-2xl bg-white border border-zinc-200 shadow-sm flex items-center justify-center hover:bg-zinc-50 transition-colors shrink-o"
          >
          ...
          {/* Progress dots */}
          <div className="flex items-center gap-1.5 shrink-o">
            {[0, 1, 2, 3].map((i) => (
              <motion.div
                key={i}
                animate={{
          ...
          <div className="p-6 space-y-7">
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <div className="w-5 h-5 rounded-full bg-zinc-900 flex items-center justify-center shrink-o">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                {VEHICLES.map((v, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-o transition-colors ${
            ...
            >
              ...
              <div className="flex items-center gap-3 bg-zinc-50 border border-zinc-200 rounded-2xl px-4 py-3 focus-within:border-zinc-900 focus-within:bg-white transition-all">
                <div className="w-8 h-8 rounded-xl bg-zinc-200 flex items-center justify-center shrink-o">
                ...
                <AnimatePresence>
                  {mobile.length >= 10 && (
                    ...
                    >
                      <CheckCircle2
                        size={16}
                        className="text-emerald-500 fill-emerald-50 shrink-o"
                      />
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              <div className="bg-zinc-50 border border-zinc-200 rounded-2xl overflow-visible">
                ...
                <div className="relative z-20">
                  <div className="flex items-center gap-3 px-4 py-3.5 focus-within:bg-white rounded-t-2xl transition-colors">
                    <div className="flex flex-col items-center shrink-o">
                    ...
                    <motion.button
                      ...
                      disabled={locating}
                      className="w-8 h-8 rounded-xl bg-zinc-200 hover:bg-zinc-300 transition-colors flex items-center justify-center shrink-o"
                    >
                      <LocateFixed
                        size={14}
                      ...
                      >
                        {pickupResults.map((p, i) => (
                          ...
                          >
                            <MapPin
                              size={13}
                              className="text-zinc-400 shrink-o"
                            />
                            ...
                            <ChevronRight
                              size={13}
                              className="text-zinc-300 shrink-o ml-auto"
                            />
                          </motion.button>
                        ))}
                      </motion.div>
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 px-4 py-3.5 focus-within:bg-white rounded-b-2xl transition-colors">
                    ...
                    <input
                      ...
                      placeholder={
                        pickupCountry ? "Drop location" : "Select pickup first"
                      }
