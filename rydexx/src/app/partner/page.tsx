    ...
    >
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6">
        <div className="min-w-0">
          <div className="mono text-[10px] tracking-[0.22em] uppercase text-signal mb-2">Operator N° 4421</div>
        ...
        <div className="hairline bg-background p-4 min-w-[260px]">
          <div className="mono text-[10px] tracking-[0.22em] uppercase text-muted-foreground flex items-center justify-between">
            <span>Srinagar · Field</span>
            <Cloud className="h-3.5 w-3.5" />
          </div>
          <div className="serif text-[38px] font-black leading-none tracking-tighter mt-2">15°C</div>
          <div className="mono text-[10px] tracking-[0.18em] uppercase text-muted-foreground mt-1">clear sky</div>
          <div className="mt-3 grid grid-cols-3 gap-2 mono text-[10px] tracking-[0.15em] uppercase">
            <span className="flex items-center gap-1"><Thermometer className="h-3 w-3 text-signal" />15°</span>
            <span className="flex items-center gap-1"><Droplets className="h-3 w-3 text-signal" />71%</span>
            <span className="flex items-center gap-1"><Wind className="h-3 w-3 text-signal" />0.78 m/s</span>
          </div>
        </div>
      </div>
    </motion.div>
    ...
    <Panel code="LEDG / 04" title="Financial Overview" accent="text-acid">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="hairline p-5 bg-background">
          ...
          <div className="serif text-[52px] font-black leading-none tracking-tighter mt-3">₹13,317</div>
          <div className="mono text-[10px] tracking-[0.18em] uppercase text-muted-foreground mt-3">
            97 total bookings dispatched
          </div>
        ...
        <div className="hairline p-5 bg-background">
          ...
          <div className="serif text-[52px] font-black leading-none tracking-tighter mt-3">₹398</div>
          <div className="mono text-[10px] tracking-[0.18em] uppercase text-muted-foreground mt-3">
  ...
  return (
    <Panel code="STRK / 05" title="Active Streak">
      <div className="flex items-end gap-4">
        ...
        <div>
          <div className="serif text-[64px] font-black leading-none tracking-tighter">0</div>
    ...
    <Panel code="GOAL / 06" title="Today's Ride Bonus" accent="text-acid">
      <div className="flex items-start gap-3">
        ...
        <p className="serif text-[18px] leading-snug">
          Complete <span className="bg-ink text-bone px-1.5">5 rides</span> today to unlock an extra{" "}
          <span className="bg-signal text-bone px-1.5">₹250</span> bonus.
        </p>
      </div>
      <div className="mt-5">
  ...
  return (
    <Panel code="EFF / 08" title="Efficiency Estimates">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto_auto] gap-4 items-end">
        <div>
          <div className="mono text-[10px] tracking-[0.22em] uppercase text-muted-foreground mb-1">Mileage Tracking · BIKE</div>
          <p className="serif italic text-[15px] text-foreground/80">
            Estimated fuel consumption tracking for your BIKE based on{" "}
            <span className="text-foreground not-italic font-bold">1308.3 km</span>.
          </p>
        </div>
        <Stat label="Distance" value="1308.3" sub="Km · 30D" />
        <Stat label="Consumed" value="29.1 L" sub="Petrol · 95 RON" />
        <Stat label="Fuel Cost" value="₹2,980" sub="Avg ₹102.4 / L" />
      </div>
      <div className="mt-5 grid grid-cols-3 gap-3 mono text-[10px] tracking-[0.22em] uppercase text-muted-foreground">
        <span className="flex items-center gap-2"><Gauge className="h-3.5 w-3.5 text-signal" /> Avg 44.9 km/L</span>
