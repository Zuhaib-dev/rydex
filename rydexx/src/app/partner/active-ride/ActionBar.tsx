...
interface ActionBarProps {
  ...
  dropOtpError: string;
  setDropOtpMode: (v: boolean) => void;
  setDropOtp: (v: string) => void;
  setDropOtpError: (v: string) => void;
  handleVerifyDropOtp: () => void;
  sendDropOtp: () => Promise<void>;
  sendingPickupOtp: boolean;
  sendingDropOtp: boolean;
}
...
export function ActionBar({
  ...
  if (!["confirmed", "arriving", "arrived", "started"].includes(status))
    return null;
