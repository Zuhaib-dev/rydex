                  ...
                  <table className="w-full text-left text-sm border-separate border-spacing-y-2">
                    ...
                    <tbody>
                      {leaderboard.length === 0 ? (
                        <tr>
                          <td colSpan={5} className="text-center py-8 text-gray-400 text-sm font-medium">No drivers ranked yet.</td>
                        </tr>
                        ...
                        return (
                          ...
                          >
                            <td className={`py-4 px-4 rounded-l-2xl font-mono font-bold ${
                            ...
                            <td className="py-4 px-4 font-bold flex items-center gap-2">
                              {driver.name} {isMe && <span className="text-[10px] bg-white/20 text-white px-2 py-0.5 rounded-full uppercase tracking-wider">You</span>}
                            </td>
                            ...
                            <td className="py-4 px-4 text-center font-mono flex items-center justify-center gap-1">
                              {driver.rating.toFixed(1)} <Star size={12} className={isMe ? "text-white" : "text-amber-400 fill-amber-400"} />
                            </td>
                            <td className="py-4 px-4 rounded-r-2xl text-right">
                              {driver.isPremiumPartner ? (
                                ...
                                <span className={`text-xs font-bold ${isMe ? "text-gray-300" : "text-gray-400"}`}>Standard</span>
                              )}
                            </td>
                          </tr>
                        );
                ...
                {!userStats?.isPremiumPartner && userStats && (
                  <div className="mt-4 bg-blue-50/50 border border-blue-100 p-4 rounded-2xl flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-blue-700 mt-1">Premium Partners receive dispatch requests before standard drivers, even if they are slightly further away.</p>
                    </div>
                  </div>
                )}
              </div>
